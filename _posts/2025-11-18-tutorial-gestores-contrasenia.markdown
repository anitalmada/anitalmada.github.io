...
Como detallé en mi último posteo en redes sociales ([Instagram](https://www.instagram.com/conalma.tech/) y [Facebook](https://www.facebook.com/conalma.tech)) existen muchos otros peligros al usar el gestor de contraseñas del navegador. Por eso, decidí hacer un tutorial detallado para mostrar cómo toda esa información en peligro puede migrarse fácilmente a un gestor de contraseñas y usar la característica de "autocompletar" al igual que lo hacíamos en el navegador
